...
public class KmeansMR {
	...
	public static void main(String[] args) throws Exception {
		...
		String oldFile = HDFS+"/gplus/output/combine_university/part-r-00000";
		String newFile = HDFS+"/gplus/output/kmeans/sample.csv";
		String resultPaht = HDFS+"/gplus/output/kmeans/output";

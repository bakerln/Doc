...
public class GplusCombined {
	...
	public static void main(String[] args) throws IOException,
		...
		String inputPath = HDFS + "/gplus/input/gplus_combined/";
		String outputPath = HDFS + "/gplus/output/gplus_combined/";
		...
		job.setJarByClass(GplusCombined.class);

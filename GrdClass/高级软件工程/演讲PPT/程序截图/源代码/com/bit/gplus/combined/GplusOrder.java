...
public class GplusOrder {
	...
	public static void main(String[] args) throws IOException,
		...
		String inputPath = HDFS + "/gplus/output/gplus_combined1/";
		String outputPath = HDFS + "/gplus/output/gplus_order/";
		...
		job.setJarByClass(GplusOrder.class);

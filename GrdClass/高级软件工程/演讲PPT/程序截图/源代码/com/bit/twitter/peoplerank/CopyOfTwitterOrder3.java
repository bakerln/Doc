 ...
 *
 */
public class CopyOfTwitterOrder3 {
	...
	public static class PageRankMapper extends
		...
		public void map(LongWritable key, Text values, Context context)
			...
			context.write(new Text(tokens[0]),
					new Text("1"));
		}
	}
	...
	public static void main(String[] args) throws IOException,
		...
		String outputPath = HDFS + "/twitter/output/twitter_combined8/";
		...
		job.setJarByClass(CopyOfTwitterOrder3.class);

...
public class TwitterFeatnames {
	...
	public static void main(String[] args) throws IOException,
		...
		String localFile1 = "logfile/twitter/feat/";
		String localFile2 = "logfile/twitter/featnames/";
		
		String inputPath1 = HDFS + "/twitter/input/feat/";
		String inputPath2 = HDFS + "/twitter/input/featnames/";
		
		if (!hdfs.exists(inputPath1)) {
		...
		String outputPath = HDFS + "/twitter/output/featnames_all/";
		...
		job.setJarByClass(TwitterFeatnames.class);

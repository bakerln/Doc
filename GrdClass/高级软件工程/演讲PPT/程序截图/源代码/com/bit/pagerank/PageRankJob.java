...
//        path.put("pr", "logfile/pagerank/peoplerank.csv");// 本地的数据文件
    ...
    private static Map<String, String> pagerank() {
        Map<String, String> path = new HashMap<String, String>();
        path.put("page", "logfile/twitter_combine/twitter_combined.csv");// 本地的数据文件
        path.put("pr", "logfile/twitter_combine/peoplerank.csv");// 本地的数据文件
        path.put("nums", "81306");// 页面数
        path.put("d", "0.85");// 阻尼系数

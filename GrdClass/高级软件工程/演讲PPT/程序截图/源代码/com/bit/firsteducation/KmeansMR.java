...
public class KmeansMR {
	...
	public static void main(String[] args) throws Exception {
		...
		String kmeansPath =HDFS + "/gplus/output/education/kmeans/center.csv";
		String oldFile = HDFS+"/gplus/output/education/3/combine/part-r-00000";
		String newFile = HDFS+"/gplus/output/education/kmeans/sample.csv";
		String resultPaht = HDFS+"/gplus/output/education/kmeans/output";
		hdfs.createFile(kmeansPath, "0 0");
